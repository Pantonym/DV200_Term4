...
function HomePage() {
    ...
    const [axiosCall, setAxiosCall] = useState('https://opendevungerer-67a33b0d08e8.herokuapp.com/api/question_get_all');
    ...
    useEffect(() => {
        if (axiosCall.startsWith('https://opendevungerer-67a33b0d08e8.herokuapp.com/api/question_get_all')) {
            Axios.get(axiosCall)
                .then(res => {
    ...
    const handleSearch = () => {
        if (searcher === '') {
            setAxiosCall('https://opendevungerer-67a33b0d08e8.herokuapp.com/api/question_get_all');
        } else {
            setAxiosCall('https://opendevungerer-67a33b0d08e8.herokuapp.com/api/searchquestion/' + searcher);
        }
    }
    ...
    const handleLoadMore = () => {
        ...
        if (newLoaded >= totalEntries) {
            setloadMoreS(false);
            setAxiosCall(`https://opendevungerer-67a33b0d08e8.herokuapp.com/api/question_get_all/?page=${nextpage}`);
        } else {
            setAxiosCall(`https://opendevungerer-67a33b0d08e8.herokuapp.com/api/question_get_all/?page=${nextpage}`);
        }
    }
