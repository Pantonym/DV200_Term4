...
function Profile() {
    ...
    useEffect(() => {
        ...
        axios.get('https://opendevungerer-67a33b0d08e8.herokuapp.com/api/userquestions/' + userID)
            .then((result) => {
        ...
        const fetchData = async () => {
            console.log('fetch');
            try {
                const userResponse = await axios.get('https://opendevungerer-67a33b0d08e8.herokuapp.com/api/getUser/' + userID);
    ...
    const save = (e) => {
        ...
        axios.put('https://opendevungerer-67a33b0d08e8.herokuapp.com/api/updateuser/' + userID, updateUser)
            .then(() => {
